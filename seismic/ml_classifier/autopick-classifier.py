...
outfile='/g/data/ha3/rlt118/neural-datasets/autopicks/ensemble.s.verified.txt'
...
with open(outfile,'w') as f, open(infile,'r') as g:
    ...
    results=network.predict_generator(datagen,workers=0,use_multiprocessing=False)
